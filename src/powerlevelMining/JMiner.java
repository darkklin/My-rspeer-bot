package powerlevelMining;

import powerlevelMining.base.Context;
import powerlevelMining.util.MiscUtil;
import powerlevelMining.util.rocks.Rock;
import powerlevelMining.util.rocks.RockHandler;
import powerlevelMining.base.tasks.MineRock;
import powerlevelMining.base.tasks.PowerDrop;
...
@ScriptMeta(name = "Mining power", version = 0.1, desc = "mining at mining guild", developer = "darkklin", category = ScriptCategory.MINING)
...
//        RockHandler.ROCK_MITHRIL = Rock.MITHRIL;
        RockHandler.ROCK_ADM = Rock.IRON;
