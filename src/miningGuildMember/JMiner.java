package miningGuildMember;

import miningGuildMember.base.Context;
import miningGuildMember.util.MiscUtil;
import miningGuildMember.util.rocks.Rock;
import miningGuildMember.util.rocks.RockHandler;
import miningGuildMember.base.tasks.MineRock;
...
@ScriptMeta(name = "Mining guildMmber", version = 0.1, desc = "mining at mining guild", developer = "darkklin", category = ScriptCategory.MINING)
